...
class ServiceCategoryAdmin(TranslatableAdmin):
    fieldsets = (
        (
            ...
            {"fields": ("name", "slug", "description", "icon", "in_home")},
        ),
        (
            _("Banner Information"),
            {"fields": ("banner_title", "banner_description", "banner_image")},
...
class AboutPageSeoAdmin(TranslatableAdmin):
    fieldsets = (
        ...
        (
            _("Content 1"),
            {"fields": ("content_title1", "content_body1", "content_image1")},
        ),
        (
            _("Content 2"),
            {"fields": ("content_title2", "content_body2", "content_image2")},
        ),
        (_("Popup Information"), {"fields": ("popup",)}),
        (_("SEO Information"), {"fields": seo_fields}),
    )
...
class BlogCategoryAdmin(TranslatableAdmin):
    fieldsets = (
        (
            _("Category Information"),
            {"fields": ("title", "slug", "description", "image", "banner_image")},
        ),
        (_("Popup Information"), {"fields": ("popup",)}),
        (_("SEO Information"), {"fields": seo_fields}),
    )
