...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('page', '0008_contactpageseo_contactpageseotranslation'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AppointmentPageSeoTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='page.appointmentpageseo')),
            ],
            options={
                'verbose_name': 'Appointment Page SEO Translation',
                'db_table': 'page_appointmentpageseo_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
