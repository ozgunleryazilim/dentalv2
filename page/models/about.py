...
class AboutPageSeo(TranslatableModel, SEOStarterModel):
    translations = TranslatedFields(
        ...
        content_title1=models.CharField(
            _("Content Title 1"), max_length=200, blank=True, null=True
        ),
        content_body1=RichTextUploadingField(
            _("Content Body 1"), blank=True, null=True
        ),
        content_title2=models.CharField(
            _("Content Title 2"), max_length=200, blank=True, null=True
        ),
        content_body2=RichTextUploadingField(
            _("Content Body 2"), blank=True, null=True
        ),
        **seo_translations
    )
    ...
    content_image1 = models.ImageField(
        _("Content Image 1"), upload_to="about", blank=True, null=True
    )
    content_image2 = models.ImageField(
        _("Content Image 2"), upload_to="about", blank=True, null=True
    )
